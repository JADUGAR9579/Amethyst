...
name: amethyst-intro
description: >
  Explain what AMETHYST can currently do and check the health of its components.
  Use when the user asks what AMETHYST is, what it can do, what tools or skills are
