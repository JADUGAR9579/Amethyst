...
**Developers**: [CONTRIBUTING.md](CONTRIBUTING.md) covers the dev install, the one-worker rule, the secrets rule and the `-e` rule — three traps a container image and a public repository each have one of.
